  ...
  return (
    <>
      ...
      <div className="max-w-lg mx-auto px-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {!photo ? (
                      ...
                      <div className="flex flex-col items-center gap-3">
                        <div className="overflow-hidden rounded-2xl border-4 border-school-blue-500 w-full max-w-[280px] sm:max-w-xs aspect-[9/16] relative group shadow-2xl bg-zinc-950 flex items-center justify-center">
                          <img src={photo} alt="Selfie do uniforme capturada" className="w-full h-full object-cover rounded-xl" />
                          <Button
                            type="button"
                            onClick={retakePhoto}
                            className="absolute top-3 right-3 w-10 h-10 p-0 rounded-full bg-red-500 hover:bg-red-600 text-white shadow-[0_0_15px_rgba(0,0,0,0.6)] border-2 border-white dark:border-zinc-800 flex items-center justify-center transition-all hover:scale-110 z-10"
        ...
        {/* Modal de Câmera Nativa Imersiva com Des-espelhamento e Otimização */}
        <CameraViewfinder
          isOpen={isCameraOpen}
